...
const newNames = runners.map(index => index.first_name.toLocaleUpperCase());

firstNamesAllCaps = newNames;
...
const largePeoples = runners.filter(index => index.shirt_size === "L");

runnersLargeSizeShirt = largePeoples;
...
const donationTotal = runners.reduce(
  (acumulator, index) => acumulator + index.donation,
  0
);
ticketPriceTotal = donationTotal;
...
// console.log(participants.id = sortId);
// console.log(participants.first_name = sortFirstName);
// console.log(participants.last_name = sortLastName);

// Problem 1

// Assign value
const sortId = runners.map(obj => obj.id);
participants.id = sortId;

// Created randomized contestent generator.
const randomizePlayer =
  Math.random(participants.id.length) * participants.id.length + 1;
console.log(Math.ceil(randomizePlayer));

// Problem 2

// Assign value
const sortFirstName = runners.map(obj => obj.first_name);
const sortLastName = runners.map(obj => obj.last_name);

participants.first_name = sortFirstName;
participants.last_name = sortLastName;

// List of sorted first and last name.
participants.first_name.sort();
participants.last_name.sort();
